...
[_BASE] = LAYOUT( \
    ...
    KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,     KC_G,    JP_MEISU, XXXXXXX, XXXXXXX,  JP_MKANA, KC_H,     KC_J,    KC_K,     KC_L,    KC_SCLN, JP_COLN, JP_RBRC,  KC_ENT, \
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,     KC_B,    KC_RCTL,  XXXXXXX, XXXXXXX,  KC_BSPC,  KC_N,     KC_M,    KC_COMM,  KC_DOT,  KC_SLSH, JP_BSLS, KC_UP,   KC_PGUP, \
